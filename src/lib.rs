...
#[derive(Debug)]
pub struct NumpyArrayProcessor {
    verbose: bool,
    processed_count: usize,
}

impl NumpyArrayProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting NumpyArray processing");
    
    let mut processor = NumpyArrayProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = NumpyArrayProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = NumpyArrayProcessor::new(false);
